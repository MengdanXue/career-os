...
- Phase 5A：半体制职业规划工作台。依据候选人**已确认**的出生日期、学历、境外硕士预计毕业时间等事实，判定其在目标年度落在“应届生”通道、社会招聘通道还是两者兼有，并生成四条路线、逐年年龄窗口、2024—2026 历史实际条件、目标年类比判断，以及公告、报名、资格审查、缴费、准考证、笔试、专业测试、面试、体检、考察、公示、聘用十二阶段流程和行动时间线。目标年类比会同步推进年龄参考日和已核验工作经历时长，不再沿用历史年份的年龄或经历结论。未确认的字段不参与硬资格判定。
- Phase 5B Slice 1：个人事实与今日行动闭环。首页只展示零至三项与该候选人有关的截止、资格证据或目标岗位变化；画像页按岗位影响排序工作经历、政治面貌、预计毕业月份、留服认证、职称、技能和研究证据缺口。空值不会被确认成“明确没有”；硬资格只使用已确认、逐段核验的全职日期区间，并按官方资格参考日合并计算完整月份，旧的总工作年数仅作提示。
