...
class CareerMvpController {
    ...
    record CandidateRequest(String displayName,int birthYear,int birthMonth,Integer birthDay,EducationLevel highestEducation,Set<String> majors,Integer graduationYear,Integer experienceYears,Set<String> professionalTitles,List<String> preferredLocations,Set<EmploymentType> acceptedEmploymentTypes,String profileVersion,Set<String> skills,Set<String> researchKeywords,Set<JobFamily> targetJobFamilies,Set<OrganizationType> preferredOrganizationTypes,List<EducationRecord> educationRecords,Gender gender,PoliticalAffiliation politicalAffiliation,List<CandidateEmploymentRecord> employmentRecords,ApplicationTimeStatus employerSettlementAtApplication,ApplicationTimeStatus socialInsuranceAtApplication) {
        CandidateRequest {
            employerSettlementAtApplication=employerSettlementAtApplication==null?ApplicationTimeStatus.UNDECLARED:employerSettlementAtApplication;
            socialInsuranceAtApplication=socialInsuranceAtApplication==null?ApplicationTimeStatus.UNDECLARED:socialInsuranceAtApplication;
        }
        CandidateRequest(String displayName,int birthYear,int birthMonth,Integer birthDay,EducationLevel highestEducation,Set<String> majors,Integer graduationYear,Integer experienceYears,Set<String> professionalTitles,List<String> preferredLocations,Set<EmploymentType> acceptedEmploymentTypes,String profileVersion,Set<String> skills,Set<String> researchKeywords,Set<JobFamily> targetJobFamilies,Set<OrganizationType> preferredOrganizationTypes,List<EducationRecord> educationRecords) {
            this(displayName,birthYear,birthMonth,birthDay,highestEducation,majors,graduationYear,experienceYears,professionalTitles,preferredLocations,acceptedEmploymentTypes,profileVersion,skills,researchKeywords,targetJobFamilies,preferredOrganizationTypes,educationRecords,Gender.UNKNOWN,PoliticalAffiliation.UNKNOWN,List.of(),ApplicationTimeStatus.UNDECLARED,ApplicationTimeStatus.UNDECLARED);
        }
        CandidateRequest(String displayName,int birthYear,int birthMonth,Integer birthDay,EducationLevel highestEducation,Set<String> majors,Integer graduationYear,Integer experienceYears,Set<String> professionalTitles,List<String> preferredLocations,Set<EmploymentType> acceptedEmploymentTypes,String profileVersion,Set<String> skills,Set<String> researchKeywords,Set<JobFamily> targetJobFamilies,Set<OrganizationType> preferredOrganizationTypes,List<EducationRecord> educationRecords,Gender gender,PoliticalAffiliation politicalAffiliation,List<CandidateEmploymentRecord> employmentRecords) {
            this(displayName,birthYear,birthMonth,birthDay,highestEducation,majors,graduationYear,experienceYears,professionalTitles,preferredLocations,acceptedEmploymentTypes,profileVersion,skills,researchKeywords,targetJobFamilies,preferredOrganizationTypes,educationRecords,gender,politicalAffiliation,employmentRecords,ApplicationTimeStatus.UNDECLARED,ApplicationTimeStatus.UNDECLARED);
        }
        CandidateProfile toDomain(UUID id){return new CandidateProfile(id,displayName,new PartialDate(birthYear,birthMonth,birthDay),highestEducation,majors,graduationYear,experienceYears,professionalTitles,preferredLocations,acceptedEmploymentTypes,"server-pending",skills,researchKeywords,targetJobFamilies,preferredOrganizationTypes,educationRecords,gender,politicalAffiliation,employmentRecords,employerSettlementAtApplication,socialInsuranceAtApplication);}
    }
