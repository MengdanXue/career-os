...
public class PersistenceAdaptersConfiguration {
    ...
    private Evidence toEvidence(JpaModels.EvidenceEntity e) { return new Evidence(e.id,e.evidenceType,e.sourceUrl,e.sourceTitle,e.excerpt,e.contentHash,e.capturedAt); }
